                                ...
                                (acc, cell, index) => {
                                    ...
                                    if (
                                        ...
                                        try {
                                            ...
                                            console.log(
                                                `Stringified object in ${sheetName}, row ${rowIndex + 1
                                                }, col ${key}:`,
                                                acc[key]
                                            );
                                        } catch (e) {
                                            console.warn(
                                                `Failed to stringify object in ${sheetName}, row ${rowIndex + 1
                                                }, col ${key}:`,
                                                cell
                                            );
...
export default Base64ToFileContent;
