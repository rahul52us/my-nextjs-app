...
const AsciiToBinaryContent: React.FC = () => {
  ...
  const convertAsciiToBinary = (ascii: string): string => {
    try {
      return ascii
        .split("")
  ...
  const handleConversion = () => {
    setLoading(true);
    setBinaryOutput("");
    const output = convertAsciiToBinary(asciiInput);
...
export default AsciiToBinaryContent;