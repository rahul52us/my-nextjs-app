...
const Base64ToBinaryContent: React.FC = () => {
  ...
  const handleConversion = () => {
    setLoading(true);
    setBinaryOutput("");
    const output = convertBase64ToBinary(base64Input);
    ...
    reader.onload = () => {
      ...
      if (content) {
        ...
        toast({
          ...
          description: "Base64 content loaded from the file.",
          status: "success",
          duration: 3000,
          isClosable: true,
        });
        ...
        <Box>
          ...
          >
            {loading ? (
              ...
              binaryOutput || "Your converted Base64 will appear here."
            )}
          </Box>
          {binaryOutput && (
...
export default Base64ToBinaryContent;
