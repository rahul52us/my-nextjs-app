...
const TextToBinaryContent: React.FC = () => {
  ...
  const handleTextToBinaryConversion = () => {
    setLoading(true);
    setBinaryOutput("");
    const output = convertTextToBinary(textInput);
  ...
  // Shared logic for reading a File object (used by both click-upload and drag-drop)
    ...
    reader.onload = () => {
      ...
      if (content) {
        ...
        toast({
          ...
          description: "Text content loaded from the file.",
          status: "success",
          duration: 3000,
          isClosable: true,
        });
      ...
      <VStack spacing={6} align="stretch">
        ...
        <HStack spacing={4} justify="space-between">
          <Button
            ...
            onClick={handleTextToBinaryConversion}
          >
            Convert to Binary
          </Button>
          ...
          <Button
            colorScheme="red"
            size="lg"
            display={textInput?.trim() ? undefined : "none"}
        ...
        <Box>
          ...
          >
            {loading ? (
              ...
              binaryOutput || "Your converted text will appear here."
            )}
          </Box>
          {binaryOutput && (
...
export default TextToBinaryContent;