...
const BinaryToTextContent: React.FC = () => {
  ...
  const handleConversion = () => {
    setLoading(true);
    setTextOutput("");
    const output = convertBinaryToText(binaryInput);
        ...
        <Box>
          ...
          >
            {loading ? (
              ...
              textOutput || "Your converted binary will appear here."
            )}
          </Box>
          {textOutput && (
            <HStack spacing={4} align="stretch">
              <Button
                ...
                onClick={() => handleCopyToClipboard(textOutput)}
              >
                Copy to Clipboard
              </Button>
              ...
              <Button
                colorScheme="green"
                size="sm"
                onClick={() => handleDownload(textOutput)}
              >
                Download Output
              </Button>
...
export default BinaryToTextContent;