...
const BinaryToAsciiContent: React.FC = () => {
  ...
  const handleConversion = () => {
    setLoading(true);
    setAsciiOutput("");
    const output = convertBinaryToAscii(binaryInput);
    ...
    <Box p={4} bg="transparent" color={textColor}>
      ...
      <VStack spacing={6} align="stretch">
        <FormControl>
          ...
          <Textarea
            placeholder="Paste your binary string here (e.g., 01001000 01100101 01101100 01101100 01101111)"
            value={binaryInput}
        ...
        <Box>
          ...
          >
            {loading ? (
              ...
              asciiOutput || "Your converted binary will appear here."
            )}
          </Box>
          {asciiOutput && (
            <HStack spacing={4} align="stretch">
              <Button
                ...
                onClick={() => handleCopyToClipboard(asciiOutput)}
              >
                Copy to Clipboard
              </Button>
              ...
              <Button
                colorScheme="green"
                size="sm"
                onClick={() => handleDownload(asciiOutput)}
              >
                Download Output
              </Button>
...
export default BinaryToAsciiContent;