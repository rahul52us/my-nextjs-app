...
const BinaryToDecimalContent: React.FC = () => {
  ...
  const handleConversion = () => {
    setLoading(true);
    setDecimalOutput("");
    const output = convertBinaryToDecimal(binaryInput);
    setDecimalOutput(output);
    setLoading(false);
  };
    ...
    <Box p={4} bg={bgColor} color={textColor}>
      ...
      <VStack spacing={6} align="stretch">
        <FormControl>
          ...
          <Textarea
            placeholder="Paste your binary number here (e.g., 11010110 or 11010110 10101010)"
            value={binaryInput}
        ...
        <Box>
          ...
          >
            {loading ? (
              ...
              decimalOutput || "Your converted binary will appear here."
            )}
          </Box>
          {decimalOutput && (
            <HStack spacing={4} align="stretch">
              <Button
                ...
                onClick={() => handleCopyToClipboard(decimalOutput)}
              >
                Copy to Clipboard
              </Button>
              ...
              <Button
                colorScheme="green"
                size="sm"
                onClick={() => handleDownload(decimalOutput)}
              >
                Download Output
              </Button>
...
export default BinaryToDecimalContent;