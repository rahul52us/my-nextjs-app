...
<Box mb={20}>
    ...
    <VStack spacing={3} mb={10} textAlign="center">
        ...
        <Text color={mutedText} maxW="xl" fontSize="md">
            Most-used tools by thousands of developers — fast, free, and browser-based.
        </Text>
    </VStack>
    ...
    <SimpleGrid columns={{ base: 1, sm: 2, md: 3 }} gap={5}>
        {[
            ...
            },
            {
                ...
                svg: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="#993556" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            },
            {
                ...
                svg: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="#993C1D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            },
            {
                ...
                svg: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="#5F5E5A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <circle cx="6.5" cy="11.5" r="1.5" fill="#185FA5" stroke="none"/>
                        <circle cx="9.5" cy="7.5" r="1.5" fill="#3B6D11" stroke="none"/>
                        <circle cx="14.5" cy="7.5" r="1.5" fill="#993C1D" stroke="none"/>
                        <circle cx="17.5" cy="11.5" r="1.5" fill="#854F0B" stroke="none"/>
                    </svg>
                ),
            },
            {
                ...
                svg: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                        ...
                        <rect x="5" y="5" width="3" height="3" fill="#185FA5" stroke="none"/>
                        <rect x="16" y="5" width="3" height="3" fill="#185FA5" stroke="none"/>
                        <rect x="5" y="16" width="3" height="3" fill="#185FA5" stroke="none"/>
            ...
            >
                <Link as={NextLink} href={tool.href} _hover={{ textDecoration: "none" }}>
                    <Box
                        bg={cardBg}
                        border="1px solid"
