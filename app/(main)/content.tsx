    ...
    >
        <Flex align="flex-end" justify="space-between" mb={12}>
            <VStack align="start" spacing={2}>
                ...
                <Heading as="h2" size="2xl" fontWeight="900" letterSpacing="tight">
                    Developer <Text as="span" color="blue.500" position="relative">
                        Ecosystem
                        <Box as="span" position="absolute" bottom="2" left="0" w="full" h="12px" bg="blue.100" zIndex={-1} opacity={0.6} />
                    </Text>
                </Heading>
            </VStack>
            ...
            >
                ...
                <VStack align="start" height="full" justify="space-between">
                    <Box>
                        ...
                        <Heading size="lg" mb={4}>Next-Gen Image Processing</Heading>
                    ...
                    <Button 
                        rightIcon={<FaArrowRight />} variant="solid" bg="white" color="blue.600" 
            ...
            >
                <Link as={NextLink} href={cat.children?.[0]?.url || "#"} _hover={{ textDecoration: "none" }}>
                    ...
                    >
                        <Flex justify="space-between" align="center" mb={8}>
                            <Box 
                                p={4} bg="blue.50" color="blue.500" borderRadius="2xl" 
                        ...
                        <Heading size="md" mb={3} _groupHover={{ color: "blue.500" }}>{cat.name}</Heading>
                        ...
                        <VStack align="start" spacing={3} flex="1">
                            {cat.children?.slice(0, 3).map((tool, idx) => (
                                <HStack key={idx} spacing={3} role="group">
                                    ...
                                    <Text fontSize="sm" fontWeight="medium" color={mutedText} _groupHover={{ color: "gray.800" }}>{tool.name}</Text>
                                </HStack>
                            ))}
                        </VStack>
                ...
                <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={10} mb={20}>
                    <VStack align="start" spacing={4}>
                        ...
                        <Heading size="md">100% Private</Heading>
                    ...
                    <VStack align="start" spacing={4}>
                        ...
                        <Heading size="md">Developer Ready</Heading>
                        <Text fontSize="sm" color={mutedText}>
                    ...
                    <VStack align="start" spacing={4}>
                        ...
                        <Heading size="md">Smart Validation</Heading>
                        <Text fontSize="sm" color={mutedText}>
                ...
                <Box bg={cardBg} p={{ base: 8, md: 12 }} borderRadius="3xl" border="1px solid" borderColor={borderColor} mb={20}>
                    <VStack align="start" spacing={6}>
                        <Heading size="lg">Understanding Base64 Encoding</Heading>
                        ...
                        <Grid templateColumns={{ base: "1fr", lg: "1.5fr 1fr" }} gap={12} w="full">
                            <VStack align="start" spacing={4}>
                                <Heading size="sm">Why use Base64?</Heading>
                            ...
                            <Box p={6} bg={bgColor} borderRadius="2xl" border="1px dashed" borderColor="blue.300">
                                <Heading size="xs" mb={3} color="blue.600">Pro Tip: Character Set</Heading>
