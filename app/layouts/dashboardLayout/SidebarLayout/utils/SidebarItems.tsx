...
const sidebarData: SidebarItem[] = [
  ...
  // ── 1. PDF Tools ─────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { id: 621, name: "Word to PDF", icon: <FaFileSignature />, iconColor: "#154360", url: "/converter/PDFtools/Wordtopdf" },
      { id: 610, name: "PDF Edit", icon: <FaEdit />, iconColor: "#8e44ad", url: "/converter/PDFtools/Pdfedit" },
      { id: 620, name: "PDF Watermark", icon: <FaWater />, iconColor: "#3498db", url: "/converter/PDFtools/Pdfwatermark" },
      { id: 617, name: "PDF Page Numbering", icon: <FaListOl />, iconColor: "#e67e22", url: "/converter/PDFtools/Pdfpageno" },
      { id: 612, name: "PDF Merge", icon: <FaObjectGroup />, iconColor: "#16a085", url: "/converter/PDFtools/Pdfmerge" },
      { id: 614, name: "PDF Split", icon: <FaCut />, iconColor: "#d35400", url: "/converter/PDFtools/Pdfsplit" },
      { id: 618, name: "PDF Page Rearrange", icon: <FaExchangeAlt />, iconColor: "#2c3e50", url: "/converter/PDFtools/Pdfpagerearange" },
      { id: 615, name: "PDF Rotate", icon: <FaUndo />, iconColor: "#c0392b", url: "/converter/PDFtools/Pdfrotate" },
      { id: 616, name: "PDF Sign", icon: <FaSignature />, iconColor: "#1abc9c", url: "/converter/PDFtools/Pdfsign" },
      { id: 619, name: "PDF Difference", icon: <FaBalanceScale />, iconColor: "#7f8c8d", url: "/converter/PDFtools/Pdfdeffrence" },
    ],
  },
 ...
 // ── 3. Base64 & Binary ────────────────────────────────────────
{
      ...
      children: [
        {
          ...
          url: "#",
          children: [
            { id: 101, name: "ASCII to Base64", icon: <FaKeyboard />, iconColor: "#e67e22", url: "/converter/encoder/ascii" },
            { id: 102, name: "Audio to Base64", icon: <FaMusic />, iconColor: "#9b59b6", url: "/converter/encoder/audio" },
            { id: 103, name: "Hex to Base64", icon: <FaHashtag />, iconColor: "#1abc9c", url: "/converter/encoder/hex" },
            { id: 104, name: "File to Base64", icon: <FaFileAlt />, iconColor: "#3498db", url: "/converter/encoder/file" },
            { id: 105, name: "URL to Base64", icon: <FaFileCode />, iconColor: "#e74c3c", url: "/converter/encoder/url" },
          ],
        },
        {
          id: 1004,
          ...
          url: "#",
          children: [
            { id: 201, name: "Base64 to ASCII", icon: <FaKeyboard />, iconColor: "#e67e22", url: "/converter/decoder/ascii" },
            ...
            { id: 205, name: "Base64 to PDF", icon: <FaFilePdf />, iconColor: "#e74c3c", url: "/converter/decoder/pdf" },
            { id: 206, name: "Base64 to Hex", icon: <FaHashtag />, iconColor: "#1abc9c", url: "/converter/decoder/hex" },
      ...
      children: [
        {
          ...
          url: "#",
          children: [
            { id: 1101, name: "Text to Binary", icon: <FaTextHeight />, iconColor: "#e74c3c", url: "/converter/binary/text-to-binary" },
            { id: 1102, name: "ASCII to Binary", icon: <FaKeyboard />, iconColor: "#3498db", url: "/converter/binary/ascii-to-binary" },
            { id: 1103, name: "Hex to Binary", icon: <FaHashtag />, iconColor: "#1abc9c", url: "/converter/binary/hex-to-binary" },
            { id: 1104, name: "Base64 to Binary", icon: <FaCode />, iconColor: "#9b59b6", url: "/converter/binary/base64-to-binary" },
            { id: 1105, name: "File to Binary", icon: <FaFileAlt />, iconColor: "#f39c12", url: "/converter/binary/file-to-binary" },
            { id: 1106, name: "Decimal to Binary", icon: <FaCalculator />, iconColor: "#16a085", url: "/converter/binary/decimal-to-binary" },
          ],
        },
        {
          id: 1006,
          ...
          url: "#",
          children: [
            { id: 1201, name: "Binary to Text", icon: <FaTextHeight />, iconColor: "#2980b9", url: "/converter/binary/binary-to-text" },
            { id: 1202, name: "Binary to ASCII", icon: <FaKeyboard />, iconColor: "#8e44ad", url: "/converter/binary/binary-to-ascii" },
            { id: 1203, name: "Binary to Hex", icon: <FaHashtag />, iconColor: "#c0392b", url: "/converter/binary/binary-to-hex" },
            { id: 1204, name: "Binary to Base64", icon: <FaCode />, iconColor: "#e67e22", url: "/converter/binary/binary-to-base64" },
            { id: 1205, name: "Binary to File", icon: <FaFileAlt />, iconColor: "#34495e", url: "/converter/binary/binary-to-file" },
            { id: 1206, name: "Binary to Decimal", icon: <FaCalculator />, iconColor: "#d35400", url: "/converter/binary/binary-to-decimal" },
          ],
        },
      ],
    },
  ...
  // ── 4. Formatters ─────────────────────────────────────────────
  {
    ...
    url: "#",
    children: [
    { id: 301, name: "JSON Formatter", icon: <FaCode />, iconColor: "#0052cc", url: "/tools/json-formatter" },
    { id: 302, name: "Text Formatter", icon: <FaFileAlt />, iconColor: "#e67e22", url: "/tools/text-formatter" },
    { id: 305, name: "Excel To Json Formatter", icon: <FaFileCode />, iconColor: "#27ae60", url: "/tools/excel-to-json" },
    { id: 306, name: "JSON To Excel", icon: <FaFileExcel />, iconColor: "#1e8449", url: "/tools/json-to-excel" },
  ],
  },
  ...
  // ── 5. File Converters ────────────────────────────────────────
  {
    ...
    url: "#",
    children: [
    { id: 401, name: "Images to PDF & Base64", icon: <FaFileImage />, iconColor: "#e74c3c", url: "/converter/images-to-pdf" },
    { id: 402, name: "Files to ZIP Compress", icon: <FaCompress />, iconColor: "#f39c12", url: "/converter/files-to-zip" },
    { id: 403, name: "ZIP to Files Decompress", icon: <FaExpandArrowsAlt />, iconColor: "#d35400", url: "/converter/decompress-zip" },
    { id: 404, name: "Encrypt File", icon: <FaLock />, iconColor: "#c0392b", url: "/converter/encrypt-file" },
    { id: 405, name: "Excel to CSV", icon: <FaFileExport />, iconColor: "#27ae60", url: "/converter/Exceltocsv" },
    { id: 406, name: "CSV to Excel", icon: <FaFileExcel />, iconColor: "#2ecc71", url: "/converter/Csvtoexcel" },
  ],
  },
...
const filterSearchData: SidebarItem[] = [
  ...
  { id: 1001, name: "Base64", icon: <FaCode />, iconColor: "#9b59b6", url: "#" },
  { id: 1002, name: "Binary", icon: <FaCode />, iconColor: "#2c3e50", url: "#" },
  ...
  { id: 1101, name: "Text to Binary", icon: <FaTextHeight />, iconColor: "#e74c3c", url: "/converter/binary/text-to-binary" },
  { id: 1102, name: "ASCII to Binary", icon: <FaCode />, iconColor: "#3498db", url: "/converter/binary/ascii-to-binary" },
  { id: 1103, name: "Hex to Binary", icon: <FaCode />, iconColor: "#1abc9c", url: "/converter/binary/hex-to-binary" },
  { id: 1104, name: "Base64 to Binary", icon: <FaCode />, iconColor: "#9b59b6", url: "/converter/binary/base64-to-binary" },
  { id: 1105, name: "File to Binary", icon: <FaFileAlt />, iconColor: "#f39c12", url: "/converter/binary/file-to-binary" },
  { id: 1106, name: "Decimal to Binary", icon: <FaCode />, iconColor: "#16a085", url: "/converter/binary/decimal-to-binary" },
  ...
  { id: 209, name: "JWT Decoder", icon: <FaLock />, iconColor: "#c0392b", url: "/converter/decoder/jwt" },
  { id: 1201, name: "Binary to Text", icon: <FaTextHeight />, iconColor: "#2980b9", url: "/converter/binary/binary-to-text" },
  { id: 1202, name: "Binary to ASCII", icon: <FaCode />, iconColor: "#8e44ad", url: "/converter/binary/binary-to-ascii" },
  { id: 1203, name: "Binary to Hex", icon: <FaCode />, iconColor: "#c0392b", url: "/converter/binary/binary-to-hex" },
  { id: 1204, name: "Binary to Base64", icon: <FaCode />, iconColor: "#e67e22", url: "/converter/binary/binary-to-base64" },
  { id: 1205, name: "Binary to File", icon: <FaFileAlt />, iconColor: "#34495e", url: "/converter/binary/binary-to-file" },
  { id: 1206, name: "Binary to Decimal", icon: <FaCode />, iconColor: "#d35400", url: "/converter/binary/binary-to-decimal" },
