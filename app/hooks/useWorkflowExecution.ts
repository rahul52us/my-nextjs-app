...
function getToolSlug(path: string, name?: string) {
  ...
  const overrides: Record<string, string> = {
    ...
    ascii: path.includes('encoder') ? 'ascii-to-base64' : 'base64-to-ascii',
    audio: path.includes('encoder') ? 'audio-to-base64' : 'base64-to-audio',
    hex: path.includes('encoder') ? 'hex-to-base64' : 'base64-to-hex',
    file: path.includes('encoder') ? 'file-to-base64' : 'base64-to-file',
    url: 'url-to-base64',
    ...
    Aichatboat: 'aichatboat',
    Cvbuilder: 'cvbuilder',
    Imagetypeconvert: 'image-type-convert',
    Bgremove: 'bgremove',
